# OT-06 Subscription Canceled Prompt
...
Exact workflow: OT-06 Subscription Canceled
Folder: 20 - Billing & Access
Exact trigger: One Time subscription projection becomes Canceled when support context is required
message_class: cancellation_help
sender_key: office
transport: GHL
Purpose: Cancellation handling.
