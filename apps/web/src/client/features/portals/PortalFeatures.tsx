...
export type StudentPortalFeatureProps = {
  ...
  onSubmitQuestion?: (occurrenceKey: string, body: string) => void;
          ...
          {currentClass && (
            <form
              ...
              onSubmit={(event) => {
                ...
                if (body.length < 3 || !onSubmitQuestion) {
                  setQuestionState('blocked');
                  return;
                }
                onSubmitQuestion(currentClass.class_key, body);
                setQuestion('');
            ...
            >
              ...
              />
              <div className="ot-action-row">
                <button type="submit" className="ot-button" disabled={!onSubmitQuestion}>
                  Send question
                </button>
                {questionState !== 'idle' && (
