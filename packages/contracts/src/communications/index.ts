...
export const communicationsCapabilitiesSchema = z.object({
  ...
  historical_backfill_dry_run: z.literal(false),
  provider_history_complete: z.literal(false),
  stored_webhooks: z.literal(false),
...
export const communicationsItemSchema = z.object({
  ...
  participant_kind: z.enum(['account', 'contact', 'household', 'unknown']),
...
export const communicationsCapabilities: CommunicationsCapabilities = {
  ...
  channels: ['email'],
  directions: ['outbound'],
  intent_types: ['password_reset', 'account_activation', 'student_pin_setup', 'student_pin_reset'],
