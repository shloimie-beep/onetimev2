ALTER TABLE onetime.telegram_command_executions
  DROP CONSTRAINT IF EXISTS telegram_command_executions_capability_ot84_check;

ALTER TABLE onetime.telegram_command_executions
  ADD CONSTRAINT telegram_command_executions_capability_ot101r_check CHECK (
    capability IN (
      'gateway.help',
      'gateway.status.read',
...
ALTER TABLE onetime.telegram_confirmations
  DROP CONSTRAINT IF EXISTS telegram_confirmations_capability_ot84_check;

ALTER TABLE onetime.telegram_confirmations
  ADD CONSTRAINT telegram_confirmations_capability_ot101r_check CHECK (
    capability IN (
      'crm.lead.create',
      'crm.lead_tag.add',
      'crm.lead_tag.remove',
