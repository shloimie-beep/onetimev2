...
| PR #6 / OT-37 PostgreSQL assurance | Applied/adapted | Added PostgreSQL 16 workflow, disposable assurance runner, scenario catalog, and local blocker evidence. Local real PostgreSQL run is blocked by missing PostgreSQL/Docker/psql/env; CI proof is expected after push. |
