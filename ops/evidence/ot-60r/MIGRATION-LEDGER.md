...
| #4 | `61d4755fe279` | `packages/db/migrations/0004_delivery_worker_claim_index.sql` | `1541303ca863105c9ccd986699b7dbc35f64bff5` | Applied as delivery lineage, then superseded by PR #8 corrected final blob. |
| #8 | `571b18f36cdc` | `packages/db/migrations/0004_delivery_worker_claim_index.sql` | `4f4dfce24a4cc82d4e6d2ad59a1a9d7e77bb900f` | Applied as final corrected delivery migration state. |
...
PR #10 / OT-47 adds no migration. Intended reserved migration ID `1400` remains not created because the packet is evidence-only and content/library implementation is `not_implemented_environmental_gate`.
