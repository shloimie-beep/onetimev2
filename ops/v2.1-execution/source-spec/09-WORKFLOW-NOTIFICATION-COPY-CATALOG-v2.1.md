...
| Parent newsletter                              |            Optional | GHL email                                  | Integrated Family Terms acceptance or later explicit newsletter permission | Suppression checked at execution                                                               |
| Marketing/nurture/reactivation                 |            Optional | GHL email                                  | Integrated Family Terms acceptance or later explicit marketing permission  | DND, unsubscribe, complaint, hard bounce, invalid address, and suppression block send          |
