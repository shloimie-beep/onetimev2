# P31 — Resend/GHL Email Copy and Approval Catalog — Locked Context

**Outcome:** Implement exact sender voice, canonical message copy, channel ownership, token-bearing Resend templates, GHL copy fragments, and human-approval enforcement.
...
**Primary writer slots:** `COPY_CATALOG`
...
### WNC-6 exact workflow copy catalog
...
### WNC-9 approval and stop conditions
