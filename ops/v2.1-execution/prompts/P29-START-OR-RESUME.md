# P29 — Core GHL Lifecycle Workflows OT-01–OT-10 and OT-13 — START OR RESUME
...
Implement the core adult/household lifecycle workflow definitions, triggers, guards, idempotency, suppression, and evidence for OT-01 through OT-10 and OT-13.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P29.yaml`  
Locked context: `ops/v2.1-execution/contexts/P29-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P29/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P29 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P29 is `ready`, its locks are unclaimed, and the
...
Primary requirements (12): `OTV2-GHL-123, OTV2-GHL-124, OTV2-GHL-125, OTV2-GHL-126, OTV2-GHL-127, OTV2-GHL-128, OTV2-GHL-129, OTV2-GHL-130, OTV2-GHL-131, OTV2-GHL-132, OTV2-GHL-133, OTV2-GHL-136`  
Primary acceptance cases (12): `OTV2-GHL-123-AC01, OTV2-GHL-124-AC01, OTV2-GHL-125-AC01, OTV2-GHL-126-AC01, OTV2-GHL-127-AC01, OTV2-GHL-128-AC01, OTV2-GHL-129-AC01, OTV2-GHL-130-AC01, OTV2-GHL-131-AC01, OTV2-GHL-132-AC01, OTV2-GHL-133-AC01, OTV2-GHL-136-AC01`  
Writer slots: `GHL_CORE_WORKFLOWS`  
Start after: `P28, P31`  
