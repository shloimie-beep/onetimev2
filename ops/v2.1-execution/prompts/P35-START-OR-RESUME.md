# P35 — Domains, Transition, Legacy Re-Registration, and Tisha B’Av Archive — START OR RESUME
...
Implement canonical domains and redirects, transition safety, legacy adult re-registration without migrated credentials/child data, and a dormant Tisha B’Av funnel template with no active product route.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P35.yaml`  
Locked context: `ops/v2.1-execution/contexts/P35-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P35/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P35 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P35 is `ready`, its locks are unclaimed, and the
...
Primary requirements (8): `OTV2-FOUNDATION-002, OTV2-DOMAIN-153, OTV2-DOMAIN-154, OTV2-DOMAIN-155, OTV2-DOMAIN-156, OTV2-DOMAIN-157, OTV2-MIGRATION-206, OTV2-MIGRATION-207`  
Primary acceptance cases (8): `OTV2-FOUNDATION-002-AC01, OTV2-DOMAIN-153-AC01, OTV2-DOMAIN-154-AC01, OTV2-DOMAIN-155-AC01, OTV2-DOMAIN-156-AC01, OTV2-DOMAIN-157-AC01, OTV2-MIGRATION-206-AC01, OTV2-MIGRATION-207-AC01`  
Writer slots: `DOMAIN_TRANSITION`  
Start after: `F01`  
