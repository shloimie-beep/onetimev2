# P10 — Admin Adult, Household, Parent, and Student Management — START OR RESUME
...
Implement secure Admin management of adult identities, households, Parent access, Student seats, credentials, ownership transfer, and account lifecycle.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P10.yaml`  
Locked context: `ops/v2.1-execution/contexts/P10-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P10/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P10 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P10 is `ready`, its locks are unclaimed, and the
...
Primary requirements (8): `OTV2-ADMIN-022, OTV2-ADMIN-023, OTV2-ADMIN-024, OTV2-ADMIN-025, OTV2-ADMIN-026, OTV2-ADMIN-027, OTV2-ADMIN-028, OTV2-ADMIN-030`  
Primary acceptance cases (8): `OTV2-ADMIN-022-AC01, OTV2-ADMIN-023-AC01, OTV2-ADMIN-024-AC01, OTV2-ADMIN-025-AC01, OTV2-ADMIN-026-AC01, OTV2-ADMIN-027-AC01, OTV2-ADMIN-028-AC01, OTV2-ADMIN-030-AC01`  
Writer slots: `ADMIN_DIRECTORY`  
