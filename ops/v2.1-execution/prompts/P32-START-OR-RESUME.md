# P32 — Consent, Privacy, Data Rights, Retention, Redaction, and Purge Ledger — START OR RESUME
...
Implement current authority/recording consent, privacy controls, export/correction/deletion flows, retention schedules, redaction, cryptographic purge evidence, and child-data safeguards.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P32.yaml`  
Locked context: `ops/v2.1-execution/contexts/P32-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P32/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P32 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P32 is `ready`, its locks are unclaimed, and the
...
Primary requirements (5): `OTV2-CONSENT-189, OTV2-PRIVACY-212, OTV2-PRIVACY-221, OTV2-PRIVACY-239, OTV2-PRIVACY-240`  
Primary acceptance cases (8): `OTV2-CONSENT-189-DEPENDENT-STUDENT, OTV2-CONSENT-189-SELF-MANAGED-ADULT-STUDENT, OTV2-PRIVACY-212-AC01, OTV2-PRIVACY-221-AC01, OTV2-PRIVACY-239-ACTOR-ROUTES, OTV2-PRIVACY-239-REQUEST-WORKFLOW, OTV2-PRIVACY-240-SNAPSHOT-REDACTION, OTV2-PRIVACY-240-RETENTION-PURGE-LEDGER`  
Writer slots: `PRIVACY_DATA_RIGHTS`  
