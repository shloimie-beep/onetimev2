# P25 — Family Plan, Free Period, Hosted Checkout, Portal, Cancellation, and Refund — START OR RESUME
...
Implement the $67 Family commercial experience, fixed free period, no-card signup boundary, GHL-hosted Checkout/billing portal, period-end cancellation, and manual refund exception.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P25.yaml`  
Locked context: `ops/v2.1-execution/contexts/P25-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P25/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P25 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P25 is `ready`, its locks are unclaimed, and the
...
Primary requirements (12): `OTV2-BILLING-101, OTV2-BILLING-102, OTV2-BILLING-103, OTV2-BILLING-104, OTV2-BILLING-105, OTV2-BILLING-106, OTV2-BILLING-107, OTV2-BILLING-108, OTV2-BILLING-109, OTV2-BILLING-110, OTV2-BILLING-224, OTV2-PARENT-038`  
Primary acceptance cases (13): `OTV2-BILLING-101-AC01, OTV2-BILLING-102-AC01, OTV2-BILLING-103-AC01, OTV2-BILLING-104-AC01, OTV2-BILLING-105-AC01, OTV2-BILLING-106-AC01, OTV2-BILLING-107-AC01, OTV2-BILLING-108-AC01, OTV2-BILLING-109-AC01, OTV2-BILLING-110-AC01, OTV2-BILLING-224-STANDARD, OTV2-BILLING-224-IMMEDIATE-EXCEPTION, OTV2-PARENT-038-AC01`  
Writer slots: `BILLING_COMMERCIAL`  
