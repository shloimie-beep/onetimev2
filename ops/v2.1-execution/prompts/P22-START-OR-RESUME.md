# P22 — Questions, Announcements, Badges, Leaderboard, and Recognition — START OR RESUME
...
Implement private Rabbi questions, announcements, fixed launch badges, attendance/question/review recognition, streaks, consent-aware aliases, and basic scoped leaderboards.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P22.yaml`  
Locked context: `ops/v2.1-execution/contexts/P22-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P22/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P22 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P22 is `ready`, its locks are unclaimed, and the
...
Primary requirements (11): `OTV2-LEARNING-093, OTV2-LEARNING-094, OTV2-LEARNING-095, OTV2-LEARNING-096, OTV2-LEARNING-097, OTV2-LEARNING-098, OTV2-LEARNING-099, OTV2-LEARNING-100, OTV2-LEARNING-196, OTV2-LEARNING-197, OTV2-LEARNING-238`  
Primary acceptance cases (12): `OTV2-LEARNING-093-AC01, OTV2-LEARNING-094-AC01, OTV2-LEARNING-095-AC01, OTV2-LEARNING-096-AC01, OTV2-LEARNING-097-AC01, OTV2-LEARNING-098-AC01, OTV2-LEARNING-099-AC01, OTV2-LEARNING-100-AC01, OTV2-LEARNING-196-AC01, OTV2-LEARNING-197-AC01, OTV2-LEARNING-238-QUESTION-DEDUPE, OTV2-LEARNING-238-RECOGNITION-CONSENT`  
Writer slots: `LEARNING_ENGAGEMENT`  
