# P11 — Admin Dashboard, Operational Views, and Global Search — START OR RESUME
...
Implement real-data Admin dashboard, authorized global search, and operable cross-domain status views without fake/demo dependencies.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P11.yaml`  
Locked context: `ops/v2.1-execution/contexts/P11-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P11/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P11 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P11 is `ready`, its locks are unclaimed, and the
...
Primary requirements (3): `OTV2-ADMIN-021, OTV2-ADMIN-029, OTV2-ADMIN-205`  
Primary acceptance cases (3): `OTV2-ADMIN-021-AC01, OTV2-ADMIN-029-AC01, OTV2-ADMIN-205-AC01`  
Writer slots: `ADMIN_OPERATIONS_UI`  
Start after: `F05, F07`  
