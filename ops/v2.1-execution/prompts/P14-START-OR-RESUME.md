# P14 — Student Application and Isolation — START OR RESUME
...
Implement the separate Student application, own-profile experience, navigation, account controls, and strict sibling/household isolation.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P14.yaml`  
Locked context: `ops/v2.1-execution/contexts/P14-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P14/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P14 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P14 is `ready`, its locks are unclaimed, and the
...
Primary requirements (10): `OTV2-STUDENT-041, OTV2-STUDENT-042, OTV2-STUDENT-043, OTV2-STUDENT-044, OTV2-STUDENT-045, OTV2-STUDENT-046, OTV2-STUDENT-047, OTV2-STUDENT-048, OTV2-STUDENT-049, OTV2-STUDENT-050`  
Primary acceptance cases (10): `OTV2-STUDENT-041-AC01, OTV2-STUDENT-042-AC01, OTV2-STUDENT-043-AC01, OTV2-STUDENT-044-AC01, OTV2-STUDENT-045-AC01, OTV2-STUDENT-046-AC01, OTV2-STUDENT-047-AC01, OTV2-STUDENT-048-AC01, OTV2-STUDENT-049-AC01, OTV2-STUDENT-050-AC01`  
Writer slots: `STUDENT_APP`  
