# F05 — Typed API, Outbox, Sagas, Retry, and Quarantine — START OR RESUME
...
Create typed API and job infrastructure with durable outbox, idempotency, retry, compensation, quarantine, and operable job state.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F05.yaml`  
Locked context: `ops/v2.1-execution/contexts/F05-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F05/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F05 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F05 is `ready`, its locks are unclaimed, and the
...
Primary requirements (3): `OTV2-API-217, OTV2-JOBS-210, OTV2-JOBS-211`  
Primary acceptance cases (3): `OTV2-API-217-AC01, OTV2-JOBS-210-AC01, OTV2-JOBS-211-AC01`  
Writer slots: `API_JOB_FOUNDATION`  
Start after: `F02`  
