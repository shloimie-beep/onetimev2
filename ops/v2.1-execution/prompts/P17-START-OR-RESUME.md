# P17 — Zoom Preparation, Settings, Registrants, and Access Delivery — START OR RESUME
...
Implement Zoom occurrence preparation, locked participant settings, per-Student registrant identity, secure short-lived bootstrap delivery, retries, and reconciliation.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P17.yaml`  
Locked context: `ops/v2.1-execution/contexts/P17-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P17/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P17 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P17 is `ready`, its locks are unclaimed, and the
...
Primary requirements (10): `OTV2-CLASSROOM-068, OTV2-CLASSROOM-069, OTV2-CLASSROOM-070, OTV2-CLASSROOM-071, OTV2-CLASSROOM-072, OTV2-CLASSROOM-074, OTV2-CLASSROOM-076, OTV2-CLASSROOM-077, OTV2-CLASSROOM-079, OTV2-CLASSROOM-188`  
Primary acceptance cases (10): `OTV2-CLASSROOM-068-AC01, OTV2-CLASSROOM-069-AC01, OTV2-CLASSROOM-070-AC01, OTV2-CLASSROOM-071-AC01, OTV2-CLASSROOM-072-AC01, OTV2-CLASSROOM-074-AC01, OTV2-CLASSROOM-076-AC01, OTV2-CLASSROOM-077-AC01, OTV2-CLASSROOM-079-AC01, OTV2-CLASSROOM-188-AC01`  
Writer slots: `ZOOM_PREPARATION`  
