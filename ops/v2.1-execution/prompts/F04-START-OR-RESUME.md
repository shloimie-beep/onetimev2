# F04 — Adult Identity, Household Ownership, Roles, and Context Switching — START OR RESUME
...
Implement one normalized adult identity, exact roles, multi-household ownership, Admin/Parent context switching, household switching, and verified ownership-transfer invariants.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F04.yaml`  
Locked context: `ops/v2.1-execution/contexts/F04-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F04/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F04 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F04 is `ready`, its locks are unclaimed, and the
...
Primary requirements (4): `OTV2-ACCOUNT-181, OTV2-ACCOUNT-182, OTV2-ACCOUNT-183, OTV2-ACCOUNT-230`  
Primary acceptance cases (4): `OTV2-ACCOUNT-181-AC01, OTV2-ACCOUNT-182-AC01, OTV2-ACCOUNT-183-AC01, OTV2-ACCOUNT-230-IDENTITY-ROLE-CONTEXT`  
Writer slots: `ACCOUNT_HOUSEHOLD_IDENTITY`  
Start after: `F02`  
