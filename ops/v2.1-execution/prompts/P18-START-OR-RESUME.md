# P18 — Embedded Classroom Join, Session Leases, Consent, and Attendance — START OR RESUME
...
Implement embedded authenticated Zoom join, one concurrent live session per Student, reconnect semantics, consent gating, occurrence windows, and attendance truth.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P18.yaml`  
Locked context: `ops/v2.1-execution/contexts/P18-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P18/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P18 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P18 is `ready`, its locks are unclaimed, and the
...
Primary requirements (5): `OTV2-CLASSROOM-073, OTV2-CLASSROOM-075, OTV2-CLASSROOM-078, OTV2-CLASSROOM-187, OTV2-CLASSROOM-232`  
Primary acceptance cases (6): `OTV2-CLASSROOM-073-AC01, OTV2-CLASSROOM-075-AC01, OTV2-CLASSROOM-078-AC01, OTV2-CLASSROOM-187-AC01, OTV2-CLASSROOM-232-TIMING, OTV2-CLASSROOM-232-BOOTSTRAP-LEASE`  
Writer slots: `EMBEDDED_CLASSROOM`  
