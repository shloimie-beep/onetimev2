# F01 — Repository Convergence, Architecture Seams, and Retired-Surface Closure — START OR RESUME
...
Make the exact v2.1 package the sole current authority, create low-conflict server/client/worker composition seams, and unmount prohibited production surfaces without deleting immutable migration history.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F01.yaml`  
Locked context: `ops/v2.1-execution/contexts/F01-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F01/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F01 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F01 is `ready`, its locks are unclaimed, and the
...
Primary requirements (8): `OTV2-FOUNDATION-001, OTV2-FOUNDATION-003, OTV2-FOUNDATION-004, OTV2-FOUNDATION-005, OTV2-FOUNDATION-006, OTV2-FOUNDATION-208, OTV2-FOUNDATION-215, OTV2-FOUNDATION-216`  
Primary acceptance cases (8): `OTV2-FOUNDATION-001-AC01, OTV2-FOUNDATION-003-AC01, OTV2-FOUNDATION-004-AC01, OTV2-FOUNDATION-005-AC01, OTV2-FOUNDATION-006-AC01, OTV2-FOUNDATION-208-AC01, OTV2-FOUNDATION-215-AC01, OTV2-FOUNDATION-216-AC01`  
Writer slots: `SERVER_COMPOSER, CLIENT_COMPOSER, WORKER_COMPOSER, CONFIG_DEPS, BARREL_REGISTRAR, RETIRED_SURFACES`  
Start after: `C00`  
