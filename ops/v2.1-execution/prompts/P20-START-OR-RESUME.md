# P20 — Media Processing, Compression, Transcription, and Draft Generation — START OR RESUME
...
Implement streaming-safe validation, resize/compression, begin/end trim, transcript/captions, review worksheet, and future knowledge-base draft generation.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P20.yaml`  
Locked context: `ops/v2.1-execution/contexts/P20-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P20/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P20 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P20 is `ready`, its locks are unclaimed, and the
...
Primary requirements (6): `OTV2-CONTENT-084, OTV2-CONTENT-085, OTV2-CONTENT-086, OTV2-CONTENT-191, OTV2-CONTENT-193, OTV2-CONTENT-233`  
Primary acceptance cases (7): `OTV2-CONTENT-084-AC01, OTV2-CONTENT-085-AC01, OTV2-CONTENT-086-AC01, OTV2-CONTENT-191-AC01, OTV2-CONTENT-193-AC01, OTV2-CONTENT-233-OBS-CAPTURE, OTV2-CONTENT-233-STORAGE-MODELS-TRANSCODE`  
Writer slots: `CONTENT_PROCESSING`  
Start after: `F05, P19`  
