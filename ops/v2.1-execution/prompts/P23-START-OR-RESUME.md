# P23 — Student In-App Notifications and Audible Cue — START OR RESUME
...
Implement exact Student notification lifecycle, unread/read behavior, safe action routing, and optional foreground audible cue while leaving email launch functionality independent.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P23.yaml`  
Locked context: `ops/v2.1-execution/contexts/P23-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P23/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P23 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P23 is `ready`, its locks are unclaimed, and the
...
Primary requirements (2): `OTV2-NOTIFY-203, OTV2-NOTIFY-237`  
Primary acceptance cases (3): `OTV2-NOTIFY-203-AC01, OTV2-NOTIFY-237-CATEGORY-LIFETIME, OTV2-NOTIFY-237-DEDUPE-READ-SOUND`  
Writer slots: `STUDENT_NOTIFICATIONS`  
Start after: `F05, F07`  
