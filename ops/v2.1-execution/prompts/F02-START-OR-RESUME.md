# F02 — Canonical Schema, State Machines, and Migration Stewardship — START OR RESUME
...
Implement canonical production schema constraints and state-machine enforcement while allocating all new forward-only migrations from 2234 upward.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F02.yaml`  
Locked context: `ops/v2.1-execution/contexts/F02-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F02/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F02 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F02 is `ready`, its locks are unclaimed, and the
...
Primary requirements (1): `OTV2-STATE-202`  
Primary acceptance cases (1): `OTV2-STATE-202-AC01`  
Writer slots: `MIGRATION_AUTHORITY, SCHEMA_CONTRACT`  
Start after: `F01`  
