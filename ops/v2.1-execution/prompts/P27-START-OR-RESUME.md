# P27 — GHL Adult Classification and Student-Contact Prohibition — START OR RESUME
...
Implement exact adult-contact matching/classification, household opportunity mapping, local-first signup synchronization, and a hard prohibition on Student GHL contacts.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P27.yaml`  
Locked context: `ops/v2.1-execution/contexts/P27-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P27/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P27 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P27 is `ready`, its locks are unclaimed, and the
...
Primary requirements (3): `OTV2-GHL-117, OTV2-GHL-118, OTV2-GHL-119`  
Primary acceptance cases (3): `OTV2-GHL-117-AC01, OTV2-GHL-118-AC01, OTV2-GHL-119-AC01`  
Writer slots: `GHL_IDENTITY`  
Start after: `F04, F06`  
