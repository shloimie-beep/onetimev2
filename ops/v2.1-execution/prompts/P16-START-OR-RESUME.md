# P16 — Class Series, Occurrences, and Canonical Enrollment — START OR RESUME
...
Implement class-series and occurrence lifecycle plus atomic automatic enrollment in the single canonical launch class.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P16.yaml`  
Locked context: `ops/v2.1-execution/contexts/P16-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P16/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P16 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P16 is `ready`, its locks are unclaimed, and the
...
Primary requirements (7): `OTV2-CLASSROOM-065, OTV2-CLASSROOM-066, OTV2-CLASSROOM-067, OTV2-CLASSROOM-184, OTV2-CLASSROOM-223, OTV2-CLASSROOM-234, OTV2-CLASSROOM-235`  
Primary acceptance cases (7): `OTV2-CLASSROOM-065-SERIES-LIFECYCLE, OTV2-CLASSROOM-066-AC01, OTV2-CLASSROOM-067-AC01, OTV2-CLASSROOM-184-AC01, OTV2-CLASSROOM-223-DRAFT-THEN-ACTIVATE, OTV2-CLASSROOM-234-FULL-LIFECYCLE, OTV2-CLASSROOM-235-ATOMIC-ENROLLMENT`  
Writer slots: `CLASSROOM_CORE`  
