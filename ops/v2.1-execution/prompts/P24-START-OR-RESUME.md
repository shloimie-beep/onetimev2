# P24 — Adult and Student Support, Rabbi Questions, and Telegram Routing — START OR RESUME
...
Implement role-appropriate support tickets, separate Torah/class questions, secure conversation access, Admin operations, and bounded Telegram notification routing.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P24.yaml`  
Locked context: `ops/v2.1-execution/contexts/P24-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P24/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P24 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P24 is `ready`, its locks are unclaimed, and the
...
Primary requirements (7): `OTV2-TICKETS-147, OTV2-TICKETS-148, OTV2-TICKETS-149, OTV2-TICKETS-150, OTV2-TICKETS-151, OTV2-TICKETS-152, OTV2-TICKETS-186`  
Primary acceptance cases (7): `OTV2-TICKETS-147-AC01, OTV2-TICKETS-148-AC01, OTV2-TICKETS-149-AC01, OTV2-TICKETS-150-AC01, OTV2-TICKETS-151-AC01, OTV2-TICKETS-152-AC01, OTV2-TICKETS-186-AC01`  
Writer slots: `SUPPORT`  
