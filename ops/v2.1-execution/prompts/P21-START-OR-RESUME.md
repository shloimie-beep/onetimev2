# P21 — Vimeo Publication, Protected Library, Search, and Resume — START OR RESUME
...
Implement approval-gated private Vimeo publication, occurrence attachment, authorized Student playback, unpublish/revoke, library search, and playback resume.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P21.yaml`  
Locked context: `ops/v2.1-execution/contexts/P21-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P21/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P21 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P21 is `ready`, its locks are unclaimed, and the
...
Primary requirements (8): `OTV2-CONTENT-087, OTV2-CONTENT-088, OTV2-CONTENT-089, OTV2-CONTENT-090, OTV2-CONTENT-091, OTV2-CONTENT-092, OTV2-CONTENT-194, OTV2-CONTENT-195`  
Primary acceptance cases (9): `OTV2-CONTENT-087-AC01, OTV2-CONTENT-088-AC01, OTV2-CONTENT-089-STUDENT, OTV2-CONTENT-089-PARENT-DENY, OTV2-CONTENT-090-AC01, OTV2-CONTENT-091-AC01, OTV2-CONTENT-092-AC01, OTV2-CONTENT-194-AC01, OTV2-CONTENT-195-AC01`  
Writer slots: `CONTENT_PUBLICATION`  
