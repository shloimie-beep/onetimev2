# P30 — Newsletter, Reactivation, and OT-16 Conversion — START OR RESUME
...
Implement Parent newsletter, former-member reactivation, and OT-16 conversion definitions with exact audience, suppression, approval, and School exclusion.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P30.yaml`  
Locked context: `ops/v2.1-execution/contexts/P30-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P30/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P30 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P30 is `ready`, its locks are unclaimed, and the
...
Primary requirements (3): `OTV2-GHL-134, OTV2-GHL-135, OTV2-GHL-225`  
Primary acceptance cases (6): `OTV2-GHL-134-AC01, OTV2-GHL-135-AC01, OTV2-GHL-225-SCHEDULE, OTV2-GHL-225-PAID-EXIT, OTV2-GHL-225-SCHOOL-EXIT, OTV2-GHL-225-SUPPRESSION`  
Writer slots: `GHL_CAMPAIGNS`  
Start after: `P28, P31`  
