# P28 — Communication Foundation, Suppression, Readback, Website Bot, and WhatsApp Preference — START OR RESUME
...
Implement the sole GHL registry, sender/suppression truth, readbacks, website lead bot, channel preference model, and email-first workflows that remain correct while WhatsApp is dormant.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P28.yaml`  
Locked context: `ops/v2.1-execution/contexts/P28-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P28/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P28 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P28 is `ready`, its locks are unclaimed, and the
...
Primary requirements (9): `OTV2-GHL-120, OTV2-GHL-121, OTV2-GHL-122, OTV2-GHL-137, OTV2-GHL-138, OTV2-GHL-198, OTV2-GHL-199, OTV2-GHL-220, OTV2-PARENT-226`  
Primary acceptance cases (10): `OTV2-GHL-120-AC01, OTV2-GHL-121-AC01, OTV2-GHL-122-AC01, OTV2-GHL-137-AC01, OTV2-GHL-138-COMMUNICATIONS-READBACK, OTV2-GHL-198-AC01, OTV2-GHL-199-AC01, OTV2-GHL-220-AC01, OTV2-PARENT-226-PREFERENCES, OTV2-PARENT-226-ESSENTIAL-EMAIL`  
Writer slots: `GHL_REGISTRY, COMMUNICATION_FOUNDATION`  
