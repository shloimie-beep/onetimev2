# P19 — Direct Upload, Drive Intake, and Source Deduplication — START OR RESUME
...
Implement Admin drag-and-drop upload through 5 GiB, Drive-folder intake, validation, streaming-safe transfer, and one deduplicated media-ingest identity.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P19.yaml`  
Locked context: `ops/v2.1-execution/contexts/P19-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P19/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P19 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P19 is `ready`, its locks are unclaimed, and the
...
Primary requirements (6): `OTV2-CONTENT-080, OTV2-CONTENT-081, OTV2-CONTENT-082, OTV2-CONTENT-083, OTV2-CONTENT-190, OTV2-CONTENT-192`  
Primary acceptance cases (6): `OTV2-CONTENT-080-AC01, OTV2-CONTENT-081-AC01, OTV2-CONTENT-082-AC01, OTV2-CONTENT-083-AC01, OTV2-CONTENT-190-AC01, OTV2-CONTENT-192-AC01`  
Writer slots: `CONTENT_INGEST`  
