# P31 — Resend/GHL Email Copy and Approval Catalog — START OR RESUME
...
Implement exact sender voice, canonical message copy, channel ownership, token-bearing Resend templates, GHL copy fragments, and human-approval enforcement.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P31.yaml`  
Locked context: `ops/v2.1-execution/contexts/P31-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P31/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P31 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P31 is `ready`, its locks are unclaimed, and the
...
Primary requirements (8): `OTV2-EMAIL-139, OTV2-EMAIL-140, OTV2-EMAIL-141, OTV2-EMAIL-142, OTV2-EMAIL-143, OTV2-EMAIL-144, OTV2-EMAIL-145, OTV2-EMAIL-146`  
Primary acceptance cases (8): `OTV2-EMAIL-139-AC01, OTV2-EMAIL-140-AC01, OTV2-EMAIL-141-AC01, OTV2-EMAIL-142-AC01, OTV2-EMAIL-143-AC01, OTV2-EMAIL-144-AC01, OTV2-EMAIL-145-AC01, OTV2-EMAIL-146-AC01`  
Writer slots: `COPY_CATALOG`  
Start after: `F01`  
Full merge after: `F01`  
Candidate integration partners (non-ordering): `F03, P28, P29, P30`  
...
- canonical email/campaign copy catalog
- Resend security/setup/reset template ownership
- GHL lifecycle/newsletter copy fragments
- human approval and digest enforcement
