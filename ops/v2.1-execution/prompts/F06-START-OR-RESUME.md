# F06 — Provider Truth, Idempotency, Reconciliation, and Mapping — START OR RESUME
...
Implement the shared provider-operation contract, provider truth/readback, exact multi-household mappings, reconciliation, and GHL ambiguity boundary.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F06.yaml`  
Locked context: `ops/v2.1-execution/contexts/F06-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F06/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F06 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F06 is `ready`, its locks are unclaimed, and the
...
Primary requirements (3): `OTV2-PROVIDER-209, OTV2-PROVIDER-231, OTV2-PROVIDER-243`  
Primary acceptance cases (3): `OTV2-PROVIDER-209-AC01, OTV2-PROVIDER-231-MULTI-HOUSEHOLD-MAPPING, OTV2-PROVIDER-243-GHL-IDENTITY-QUARANTINE`  
Writer slots: `PROVIDER_CORE, PROVIDER_REGISTRY`  
Start after: `F04, F05`  
