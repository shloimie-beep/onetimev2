# F03 — Adult and Student Authentication — START OR RESUME
...
Deliver exact email/password adult authentication and username/password Student authentication with the locked password, setup, reset, session, rate-limit, revocation, and no-MFA policy.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/F03.yaml`  
Locked context: `ops/v2.1-execution/contexts/F03-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/F03/TASK-STATE.yaml`  
...
3. Read the exact branch/status for F03 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when F03 is `ready`, its locks are unclaimed, and the
...
Primary requirements (16): `OTV2-AUTH-007, OTV2-AUTH-008, OTV2-AUTH-009, OTV2-AUTH-010, OTV2-AUTH-011, OTV2-AUTH-012, OTV2-AUTH-013, OTV2-AUTH-014, OTV2-AUTH-015, OTV2-AUTH-016, OTV2-AUTH-017, OTV2-AUTH-018, OTV2-AUTH-019, OTV2-AUTH-020, OTV2-AUTH-180, OTV2-AUTH-227`  
Primary acceptance cases (22): `OTV2-AUTH-007-AC01, OTV2-AUTH-008-AC01, OTV2-AUTH-009-AC01, OTV2-AUTH-010-AC01, OTV2-AUTH-011-AC01, OTV2-AUTH-012-AC01, OTV2-AUTH-013-SINGLE-USE-TTL, OTV2-AUTH-013-RENEWAL, OTV2-AUTH-014-AC01, OTV2-AUTH-015-AC01, OTV2-AUTH-016-AC01, OTV2-AUTH-017-AC01, OTV2-AUTH-018-AC01, OTV2-AUTH-019-AC01, OTV2-AUTH-020-CSRF, OTV2-AUTH-020-RATE, OTV2-AUTH-020-COOKIE, OTV2-AUTH-020-ROTATE, OTV2-AUTH-180-AC01, OTV2-AUTH-227-PASSWORDS-RATE-LIMITS, OTV2-AUTH-227-SESSIONS-TOKENS-LEASES, OTV2-AUTH-227-WEBHOOK-WORKER`  
Writer slots: `IDENTITY_AUTH_ACCESS`  
Start after: `F02`  
