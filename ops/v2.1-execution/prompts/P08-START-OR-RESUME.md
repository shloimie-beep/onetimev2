# P08 — Family Signup, Deduplication, Expiry, and Recovery — START OR RESUME
...
Implement cardless Family signup, pre/post-expiry access branching, adult dedupe, interrupted recovery, and safe duplicate handling.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P08.yaml`  
Locked context: `ops/v2.1-execution/contexts/P08-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P08/TASK-STATE.yaml`  
Handoff: `ops/v2.1-execution/runtime/P08/HANDOFF.md`
...
3. Read the exact branch/status for P08 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P08 is `ready`, its locks are unclaimed, and the
...
Primary requirements (5): `OTV2-SIGNUP-176, OTV2-SIGNUP-177, OTV2-SIGNUP-179, OTV2-SIGNUP-213, OTV2-SIGNUP-228`  
Primary acceptance cases (6): `OTV2-SIGNUP-176-FAMILY-OR-SCHOOL-BRANCH, OTV2-SIGNUP-177-AC01, OTV2-SIGNUP-179-AC01, OTV2-SIGNUP-213-AC01, OTV2-SIGNUP-228-BEFORE-EXPIRY, OTV2-SIGNUP-228-AT-AND-AFTER-EXPIRY`  
Writer slots: `FAMILY_SIGNUP`  
