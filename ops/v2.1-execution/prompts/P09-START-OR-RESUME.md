# P09 — School Inquiry and Approved-School Accounts — START OR RESUME
...
Implement manual-sales School inquiry and approved-school configuration using the same Parent/Student product with no school-specific role or portal.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P09.yaml`  
Locked context: `ops/v2.1-execution/contexts/P09-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P09/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P09 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P09 is `ready`, its locks are unclaimed, and the
...
Primary requirements (4): `OTV2-SIGNUP-178, OTV2-SIGNUP-229, OTV2-SCHOOL-200, OTV2-SCHOOL-214`  
Primary acceptance cases (4): `OTV2-SIGNUP-178-SCHOOL-INQUIRY-NO-ACCESS, OTV2-SIGNUP-229-PUBLIC-SCHOOL-INQUIRY, OTV2-SCHOOL-200-AC01, OTV2-SCHOOL-214-AC01`  
Writer slots: `SCHOOL_INQUIRY`  
Start after: `P08`  
