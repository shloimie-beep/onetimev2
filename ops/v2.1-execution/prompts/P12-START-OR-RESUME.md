# P12 — Parent Household and Student-Seat Management — START OR RESUME
...
Implement the Parent-only household overview and up-to-three-Student management experience with safe username/password reset and exact authority boundaries.

Repository: `shloimie-beep/onetimev2`  
Task packet: `ops/v2.1-execution/tasks/P12.yaml`  
Locked context: `ops/v2.1-execution/contexts/P12-CONTEXT.md`  
Runtime state: `ops/v2.1-execution/runtime/P12/TASK-STATE.yaml`  
...
3. Read the exact branch/status for P12 from fetched
...
5. If it does not exist, read `READY-QUEUE.yaml` from the fetched remote control
   branch. Start only when P12 is `ready`, its locks are unclaimed, and the
...
Primary requirements (7): `OTV2-PARENT-031, OTV2-PARENT-032, OTV2-PARENT-033, OTV2-PARENT-034, OTV2-PARENT-035, OTV2-PARENT-036, OTV2-PARENT-040`  
Primary acceptance cases (7): `OTV2-PARENT-031-AC01, OTV2-PARENT-032-AC01, OTV2-PARENT-033-AC01, OTV2-PARENT-034-AC01, OTV2-PARENT-035-AC01, OTV2-PARENT-036-AC01, OTV2-PARENT-040-AC01`  
Writer slots: `PARENT_HOUSEHOLD_UI`  
Start after: `F03, F04, F07`  
Full merge after: `F03, F04, F07`  
Candidate integration partners (non-ordering): `P16, P32`  
...
- Parent household overview
- Student create/update/archive/reactivate within allowance
- username/password set/reset without password display
- Parent-only role and household isolation
