...
- Pipeline stages: `Warm Leads` → `Old App — Active` → `Old App — Inactive` → `Active Member` → `Canceled / Lost`.
- `Old App` stages are temporary. Stage ID `b87ce5c3-d877-4009-99bd-6012da7e455d` maps to `Active Member`.
- Every acquisition funnel enters `Warm Leads`; source identity remains in source/funnel/campaign fields.
