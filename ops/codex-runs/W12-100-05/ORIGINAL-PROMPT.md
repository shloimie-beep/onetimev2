...
2. Push the branch.
3. Open a draft PR against integration/w12-final-convergence-20260717T123715Z
...
LANE-ID: W12-100-05
Branch: codex/w12-100-05-postgres-migration-rehearsal

Exclusive ownership:
- scripts/w12-100/postgres/**
- tests/integration/w12-100-postgres/**
- ops/codex-runs/W12-100-05/**

Do not edit existing checked migrations unless you find a proven correctness defect. Existing migrations are forward-only and checksummed.

Rehearse the exact W12 migration transition through:
- 2200_w12_02_communication_history.sql
- 2201_w12_01_crm_audience_import.sql
- 2202_w12_05_telegram_operations.sql

Run against disposable PostgreSQL 16 and PostgreSQL 18 environments.

Test:
- clean database migration
- upgrade from a schema ending at migration 2190
- checksum verification
- repeat verification/idempotence behavior
- transactional failure behavior
- constraint compatibility
- existing-row compatibility for Telegram constraint replacement
- foreign-key ordering
- index creation behavior
- lock acquisition and estimated blocking
- application startup before and after migrations
- web and worker compatibility during a rolling deployment
- backup/restore into a disposable clone
- forward corrective migration procedure

Record timings, table counts, schema hashes, and lock observations only.
Never connect to production.

Produce:
- MIGRATION-REHEARSAL.json
- COMPATIBILITY-MATRIX.md
- STAGING-MIGRATION-RUNBOOK.md
- FORWARD-ROLLBACK-PLAN.md

Define an exact stop condition for any lock, data incompatibility, checksum mismatch, or non-idempotent result.
