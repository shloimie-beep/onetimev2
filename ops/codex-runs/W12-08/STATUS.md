...
| W12-08-008 | Run focused verification, record final evidence, push, and open draft PR.                                                                                                                           | In progress | Local verification complete; commit/push/draft PR pending. No deploy.                                                                                             |
