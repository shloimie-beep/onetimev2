...
- Use one additive migration, `2010_ops06_reliability_observability.sql`, for durable worker heartbeats, synthetic probe run summaries, restore drills, and retention job contracts.
