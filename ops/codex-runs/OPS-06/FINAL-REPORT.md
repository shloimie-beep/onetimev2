...
- Added additive migration `2015_ops06_reliability_observability.sql` for worker heartbeats, synthetic probe summaries, restore drills, and retention job records.
