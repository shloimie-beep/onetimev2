...
function assertNativePostgresql(value: unknown): asserts value is NativePostgresqlResult {
  ...
  if (value.migration_count !== 92 || value.pending_count !== 0 || value.issue_count !== 0) {
    throw new Error('native_postgresql must report exactly 92 migrations, pending 0, issues 0');
  }
