...
<main class="landing-page">
  ...
  <section class="section enrollment" id="enrollment">
    ...
    <div class="information-grid">
      <article><h3>${escapeHtml(landingContent.enrollment.family.title)}</h3><p>${escapeHtml(landingContent.enrollment.family.body)}</p><a class="text-link" href="/signup">Enroll your son free</a></article>
    </div>
  </section>
  <section class="section access" id="access" data-access-boundary="${freeAccessExpiresAtPlaceholder}">
    ...
    <div class="access-state" data-before-expiry hidden>
      ...
      <a class="button button-primary" href="/signup">Create my free family account</a>
    </div>
    <div class="access-state" data-at-or-after-expiry>
      <p>${escapeHtml(landingContent.access.after)}</p>
      <a class="button button-primary" href="/signup">$67/month — create account</a>
    </div>
  </section>
  ...
  <section class="final-cta"><h2>${escapeHtml(landingContent.finalCta.heading)}</h2><a class="button button-primary" href="/signup">Create my family account</a></section>
</main>${footer()}`,
    {
      canonicalPath: '/',
