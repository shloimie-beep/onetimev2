...
OT-34, OT-36, and later integration branches can run the same command after
rebasing or stacking on a branch that contains this harness. Add new scenarios
under `tests/postgres-assurance/` and call them from
